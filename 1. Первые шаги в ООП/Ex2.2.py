...
# Создайте тысячу таких объектов с координатами (1, 1), (3, 3), (5, 5), ... то есть, с увеличением на
# два для каждой новой точки. Каждый объект следует поместить в список points (по порядку). Для второго
...
for i in range(1, 2000, 2):
    #vars()['p'+ str(i)] = Point(i, i)
    #print(['p'+ str(i)])
    points.append(Point(i, i))
points[1].color = "yellow"
points[1].color = "yelow"
